...
function tracerConfig(codeql, database, compilerSpec) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        yield exec.exec(codeql.cmd, ['database', 'trace-command', database,
            ...compilerSpecArg,
            process.execPath, path.resolve('lib/tracer-env.js')], { silent: true, listeners: { stdout: (data) => { output += data.toString(); },
...
function run() {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            const dockerTracerConfig = yield tracerConfig(codeqlSetup, databaseFolder, path.resolve('src', 'docker-compiler-settings'));
