...
function run() {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            // patch up slashes
            yield exec.exec('sed', ['-i.bak', '-e', 's#\\\\#/#g', tracerConf]);
            yield exec.exec('sed', ['-i.bak', '-e', 's#{0}#' + path.join(codeqlFolder, 'odasa') + '#g', tracerConf]);
            yield exec.exec('sed', ['-i.bak', '-e', 's#{1}#' + path.resolve('build-tracer.log') + '#g', tracerConf]);
